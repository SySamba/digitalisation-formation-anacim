                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <select class="form-select formation-required" name="centre_formation[<?= $formation['id'] ?>]" onchange="toggleCustomCenter(this, <?= $formation['id'] ?>)">
                                                            <option value="">Sélectionner...</option>
                                                            <option value="ANACIM" <?= $is_completed && isset($formations_effectuees[array_search($formation['id'], $formations_effectuees_ids)]['centre_formation']) && $formations_effectuees[array_search($formation['id'], $formations_effectuees_ids)]['centre_formation'] == 'ANACIM' ? 'selected' : '' ?>>ANACIM</option>
                                                            ...
                                                            <option value="autres" <?= $is_completed && isset($formations_effectuees[array_search($formation['id'], $formations_effectuees_ids)]['centre_formation']) && !in_array($formations_effectuees[array_search($formation['id'], $formations_effectuees_ids)]['centre_formation'], ['ANACIM', 'ENAC', 'ERNAM', 'ITAerea', 'IFURTA', 'EPT', 'IFNPC', 'EMAERO services']) ? 'selected' : '' ?>>Autres</option>
                                                        </select>
                                                        <input type="text" class="form-control mt-2 custom-center" name="centre_formation_custom[<?= $formation['id'] ?>]" 
                                                               ...
                                                               value="<?= $is_completed && isset($formations_effectuees[array_search($formation['id'], $formations_effectuees_ids)]['centre_formation']) && !in_array($formations_effectuees[array_search($formation['id'], $formations_effectuees_ids)]['centre_formation'], ['ANACIM', 'ENAC', 'ERNAM', 'ITAerea', 'IFURTA', 'EPT', 'IFNPC', 'EMAERO services']) ? htmlspecialchars($formations_effectuees[array_search($formation['id'], $formations_effectuees_ids)]['centre_formation']) : '' ?>">
                                                    </div>
                                                    <div class="col-md-3">
